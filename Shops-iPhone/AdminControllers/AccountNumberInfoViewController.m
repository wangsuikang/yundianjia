//
//  AccountNumberInfoViewController.m
//  Shops-iPhone
//
...
@interface AccountNumberInfoViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation AccountNumberInfoViewController
...
- (void)viewDidLoad {
    ...
    NSArray *sectionOne = @[@"用户名", @"用户密码", @"手机号码"];
    NSArray *sectionTwo = @[@"电子邮箱"];
