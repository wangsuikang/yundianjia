//
//  AdminCmpanyInfoViewController.m
//  Shops-iPhone
//
...
@interface AdminCompanyInfoViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation AdminCompanyInfoViewController
...
- (void)viewDidLoad {
    ...
    NSArray *sectionOne = @[@"公司名称", @"法定代表人姓名", @"法定代表证件类型"];
