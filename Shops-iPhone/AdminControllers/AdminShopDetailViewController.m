//
//  AdminShopDetailViewController.m
//  Shops-iPhone
//
...
@interface AdminShopDetailViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation AdminShopDetailViewController
...
- (void)viewDidLoad {
    ...
    NSArray *sectionOne = @[@"店铺名称", @"商户简介", @"店铺简介"];
    NSArray *sectionTwo = @[@"联系客服"];
