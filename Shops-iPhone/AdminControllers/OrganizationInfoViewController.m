...
@interface OrganizationInfoViewController () <UITableViewDataSource, UITableViewDelegate>
...
- (void)viewDidLoad {
    ...
    NSArray *sectionOne = @[@"组织机构代码", @"有效开始时间", @"有效结束时间"];
    NSArray *sectionTwo = @[@"企业组织机构代码证"];
