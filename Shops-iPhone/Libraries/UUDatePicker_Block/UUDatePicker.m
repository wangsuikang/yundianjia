...
- (NSInteger)numberOfComponentsInPickerView:(UIPickerView *)pickerView
{
    if (self.datePickerStyle == UUDateStyle_YearMonthDayHourMinute) {
        if (isIOS7) {
            [self creatValuePointXs:@[@((self.frame.size.width - 370) / 2 + 100),@((self.frame.size.width - 370) / 2 + 90 + 62),@((self.frame.size.width - 370) / 2 + 160 + 50),@((self.frame.size.width - 370) / 2 + 230 + 38),@((self.frame.size.width - 370) / 2 + 300 + 22)]
                          withNames:@[@"年",@"月",@"日",@"时",@"分"]];
        }
    ...
    if (self.datePickerStyle == UUDateStyle_YearMonthDay) {
        if (isIOS7) {
            [self creatValuePointXs:@[@((self.frame.size.width - 220) / 2 + 60),@((self.frame.size.width - 220) / 2 + 70 + 70),@((self.frame.size.width - 220) / 2 + 70 + 100 + 50)]
                          withNames:@[@"年",@"月",@"日"]];
            }
