...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.shouldUnderline) {
        ...
        CGSize fontSize = [self.text sizeWithFont:self.font size:CGSizeMake(self.frame.size.width, 0)];
...
- (void)setText:(NSString *)text andCenter:(CGPoint)center
{
    ...
    CGSize fontSize = [self.text sizeWithFont:self.font size:CGSizeMake(200, 0)];
